  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-[12px] text-white/40 flex items-center gap-1 mb-0.5">
  ...
  return (
    <div className="min-h-screen bg-ink">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-12 pb-8">
        <p className="font-mono text-[12px] tracking-[0.2em] uppercase text-white/40 mb-3">Dashboard</p>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-12">
        <div className="flex items-center justify-between mb-5">
          ...
          {bookedItems.length > 0 && (
            <Link href="/bookings" className="text-[13px] text-white/40 hover:text-white/70 transition-colors flex items-center gap-1">
              View all
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16">
        <div className="flex items-center justify-between mb-5">
          ...
          {savedItems.length > 0 && (
            <Link href="/saved" className="text-[13px] text-white/40 hover:text-white/70 transition-colors flex items-center gap-1">
              View all
              <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          )}
